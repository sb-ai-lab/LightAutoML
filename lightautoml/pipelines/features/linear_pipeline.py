...
class LinearFeatures_no_te_no_int(FeaturesPipeline, TabularDataFeatures):
    def __init__(self, feats_imp: Optional[ImportanceEstimator] = None, top_intersections: int = 0,
                 max_bin_count: int = 10,
                 max_intersection_depth: int = 0, subsample: Optional[Union[int, float]] = None,
                 sparse_ohe: Union[str, bool] = 'auto', auto_unique_co: int = 50, output_categories: bool = True,
                 multiclass_te_co: int = 0, **kwargs):
