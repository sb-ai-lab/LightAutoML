...
# from lightautoml.ml_algo.base import Normal
...
#             return hp.loguniform(label=name, low=self.choice.low, high=self.choice.high)
#         elif self.choice.log and self.choice.q:
