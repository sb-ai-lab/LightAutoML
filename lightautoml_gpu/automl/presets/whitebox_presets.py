...
class WhiteBoxPreset(AutoMLPreset):
    ...
    def create_automl(self, *args, **kwargs):
        """Create basic :class:`~lightautoml_gpu.automl.presets.whitebox_presets.WhiteBoxPreset` instance from data.
    ...
    def fit_predict(
        ...
        **fit_params
        ...
        Args:
            ...
            cv_iter: Custom cv-iterator. For example, :class:`~lightautoml_gpu.validation.np_iterators.TimeSeriesIterator`.
