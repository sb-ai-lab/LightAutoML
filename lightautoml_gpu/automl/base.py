...
class AutoML:
    ...
    AutoML steps:
        ...
        - Returns prediction on validation data.
          ...
          :class:`~lightautoml_gpu.validation.np_iterators.TimeSeriesIterator`
    ...
    Args:
        reader: Instance of Reader class object that
            creates :class:`~lightautoml_gpu.dataset.base.LAMLDataset`
            from input data.
        levels: List of list
            of :class:`~lightautoml_gpu.pipelines.ml..base.MLPipelines`.
        timer: Timer instance of
            :class:`~lightautoml_gpu.utils.timer.PipelineTimer`.
            Default - unlimited timer.
        blender: Instance of Blender.
            Default - :class:`~lightautoml_gpu.automl.blend.BestModelSelector`.
    ...
    def _initialize(
        ...
        Args:
            reader: Instance of Reader class object that
                creates :class:`~lightautoml_gpu.dataset.base.LAMLDataset` from input data.
            levels: List of list of :class:`~lightautoml_gpu.pipelines.ml..base.MLPipelines`.
            timer: Timer instance of :class:`~lightautoml_gpu.utils.timer.PipelineTimer`.
                Default - unlimited timer.
            blender: Instance of Blender. Default - :class:`~lightautoml_gpu.automl.blend.BestModelSelector`.
            skip_conn: True if we should pass first level
                input features to next levels.
