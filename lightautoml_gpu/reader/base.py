...
class Reader:
    ...
    :class:`~lightautoml_gpu.dataset.base.LAMLDataset` from raw data.
...
class PandasToPandasReader(Reader):
    ...
    Reader to convert :class:`~pandas.DataFrame` to AutoML's :class:`~lightautoml_gpu.dataset.np_pd_dataset.PandasDataset`.
    Stages:
...
class DictToPandasSeqReader(PandasToPandasReader):
    """Reader with sequential support to convert :class:`~pandas.DataFrame` to AutoML's :class:`~lightautoml_gpu.dataset.np_pd_dataset.PandasDataset`.
