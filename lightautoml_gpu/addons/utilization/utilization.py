...
class TimeUtilization:
    """Class that helps to utilize given time to :class:`~lightautoml_gpu.automl.presets.base.AutoMLPreset`.
    ...
    Note:
        ...
        called like usual :class:`~lightautoml_gpu.automl.base.AutoML` class.
    ...
    def fit_predict(
        ...
        Almost same as :meth:`lightautoml_gpu.automl.base.AutoML.fit_predict`.
    ...
    def predict(
        ...
        **kwargs,
        ...
        Almost same as :meth:`lightautoml_gpu.automl.base.AutoML.predict`
